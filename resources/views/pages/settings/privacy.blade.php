...
@php $pageTitle = 'Settings'; $pageBreadcrumb = 'Privacy'; $pageSubtitle = 'Manage your privacy settings and preferences.'; @endphp
        ...
        <div class="settings-container container">
            <div class="settings-content">
                ...
                <div class="settings-main-content">
                    ...
                    foreach($privacy_settings_type as $type => $type_info) {
                        ?>
                        <div class="settings-content-section">
                            <div class="settings-content-section-header">
                                <h3>{{ $type_info['label'] }}</h3>
                                <p>Manage your {{ strtolower($type_info['label']) }} privacy settings below.</p>
                            </div>
                            <form method="post" action="{{ route('settings.privacy.update') }}">
                                ...
                                $is_enabled = $privacy_settings->{$type_info['key']};
                                ?>
